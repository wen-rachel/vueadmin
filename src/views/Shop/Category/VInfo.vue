<template>
  <el-dialog :title="info.isAdd ? '添加分类':'修改分类'" :visible.sync="info.isShow" width="40%">
    <!-- 表单 -->
    <el-form :model="forminfo" ref="form" :rules="rules" label-width="140px">
      ...
      <el-form-item :label="forminfo.type==1 ?'目录名称':'分类名称'" prop="catename">
...
let defaultItem = {
  // 这里面的数据要根据项目文档来写，项目文档中需要哪些数据就加哪些
  pid: 0,
  catename: "",
  img: "",
  status: 1, // 状态1正常2禁用
};
// 为了清空表单剩余内容的 整一个干净的数据集
...
export default {
  ...
  methods: {
    ...
    cancel() {
      //  // 无论是修改成功还是添加成功，都应该让表单为空或者弹框关闭的时候
      this.forminfo = { ...resetItem };
       this.filelist = [];
    },
  },
